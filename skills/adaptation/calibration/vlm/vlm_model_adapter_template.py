...
class MyVLMModelAdapter(
    ...
    def handle_dataset(self, dataset: Any, device: DeviceType = DeviceType.NPU) -> List[Any]:
        ...
        """
        self._processor = AutoProcessor.from_pretrained(  # nosec B615 - local_files_only=True 仅加载本地模型，不触发远程下载
            self.model_path,
    ...
    def _load_model(self, device: DeviceType) -> nn.Module:
        """Placeholder: implement VLM loading (see e.g. qwen2_5_vl adapter)."""
        raise NotImplementedError("Implement _load_model for the target VLM.")
