...
| ------------------ | -------------------------------------------------------------------------------------- | ------------- | ------------------------------- | ------------------------------------------------ |
| Qwen3-VL-235B-A22B | [Qwen3-VL-235B-A22B](https://huggingface.co/Qwen/Qwen3-VL-235B-A22B-Instruct/tree/main) | W8A8 混合量化 | MindIE 待支持vLLM Ascend 支持中 | [W8A8 混合量化](#qwen3-vl-moe-w8a8-混合量化)      |
| Qwen3-VL-30B-A3B   | [Qwen3-VL-30B-A3B](https://huggingface.co/Qwen/Qwen3-VL-30B-A3B-Instruct/tree/main)     | W8A8 混合量化 | MindIE 待支持vLLM Ascend 支持中 | [W8A8 混合量化](#qwen3-vl-moe-30b-A3b-w8a8-mxfp8) |
