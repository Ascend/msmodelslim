...
| Gemma4 | W8A8量化；MXFP8/MXFP4 混合量化 | [gemma-4-31B-it](https://huggingface.co/google/gemma-4-31B-it) | vLLM Ascend（MXFP 仅支持昇腾950PR&950DT系列产品） | 《[Gemma4 量化使用说明](./Gemma4/README.md)》 |
...
| Gemma4-MoE | W8A8动态量化（MoE专家动态量化）；MXFP8/MXFP4 混合量化 | [gemma-4-26B-A4B-it](https://huggingface.co/google/gemma-4-26B-A4B-it) | vLLM Ascend 支持（MXFP仅支持昇腾950PR&950DT系列产品） | 《[Gemma4-MoE 量化使用说明](./Gemma4-MoE/README.md)》 |
