# -*- coding: UTF-8 -*-
# This code is based on the InternVL3.5 project.
# This project is released under the Apache-2.0 License.
# This project uses the pre-trained Qwen3 as a component,
...
def _dynamic_preprocess(image, min_num=1, max_num=12, image_size=448, use_thumbnail=False):
    ...
    if len(processed_images) != blocks:
        raise SchemaValidateError("The number of processed images does not match the expected number of blocks.")
