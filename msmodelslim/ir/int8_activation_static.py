...
@QABCRegistry.multi_register(dispatch_key=[int8_per_head_sym], abc_type=AutoFakeQuantActivation)
@logger_setter()
class INT8FakeQuantActivationPerHead(FakeQuantActivationPerHead):
    """对称 per-head 伪量化/反量化。
