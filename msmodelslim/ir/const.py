...
mxfp8_per_channel_sym = QScheme(scope=QScope.PER_CHANNEL, dtype=QDType.MXFP8, symmetric=True)
...
fp8_e4m3_per_head_sym = QScheme(scope=QScope.PER_HEAD, dtype=QDType.FP8_E4M3, symmetric=True)
